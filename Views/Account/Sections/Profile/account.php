                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="4" cols="80" class="form-control" placeholder="Here can be your description" value="Mike">Développeur Web Junior sur OpenClassrooms, en alternance avec Qwant Music.</textarea>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card card-user">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="description text-center">
                                        ...
                                        <br> sur OpenClassrooms,
                                        <br> en alternance avec Qwant Music.
                                    </p>
                                </div>
                            </div>
                        </div>
