        ...
        <div class="row">
            <div class="col-md-12 col-md-5 textHeaderAbout">
                <div class="text-container">
                    <h2 class="section-title text-center text-uppercase">Biographie de Jean Forteroche</h2>
                    <div>
                        <p class="section-subheading text-muted">Venez découvrir ma biographie.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
                <div class="about-mf">
                    <div id="about" class="box-shadow-full">
                        <div class="row">
                            <div class="col-md-4 blockImg">
                                <div class="item">
                                    <div class="imgContainer">
                                        <img src="Public/images/profil.jpg" alt="" style="width: 100%" />
                                    </div>
                            ...
                            <div class="col-md-8 blockText">
                                <div class="row col-md-12">
                                    <p class="col-md-12">Bonjour je m'appelle Jean Forteroche et je suis né à Paris le 10 Mai 1977. D'abords inspiré 
                                        par le théatre, j'ai suivi des cours à 12 ans afin de devenir acteur. Encouragé par mon professeur, j'ai été 
                                    ...
                                    <p class="col-md-12">Après mes études en psychologie social à Paris, je me suis passionné pour les voyages. 
                                        ...
                                        En février 2003, j'ai publié mon premier roman, Milwoo le chien errant. Avec 5 millions d’exemplaires vendus dans 
                                        le monde, je suis devenu l'un des auteurs français contemporains les plus lus en france.
                                    </p>
                                    <p class="col-md-12">En juin 2003, je suis parti voyager en Pologne afin d'écrire un second roman intitulé : Le Sorceleur. 
                                        Le Sorceleur (Wiedźmin), ne fut publiée en mars 2008 dans Fantastyka, le magazine de littérature fantastique polonais
                                        ...
                                        livres ont fait de moi l'un des auteurs fantastiques les plus connus de la Pologne des années 2000.
                                    </p>
                                    <p class="col-md-12">Lors de mes nombreuses années passé en Pologne, j'ai eu l'occasion de gagner cinq fois le prix 
                                        Janusz A. Zajdel, trois fois pour les nouvelles Mniejsze zło (Moindre mal) (2009), Miecz przeznaczenia 
                                        (L'Épée du Destin) (2010), W leju po bombie (Dans un cratère de bombe) (2011), et deux fois pour les romans 
                                        Krew elfów (Le Sang des Elfes) (2013) et Narrenturm (2016). En 2018, j'ai pu gagner le tout premier prix David 
                                        Gemmell du meilleur roman de fantasy pour Krew elfów (Le Sang des Elfes).
                                    </p>
                                    <p class="col-md-12">En 2014, j'ai également remporté le prestigieux prix Paszport Polityki, remis annuellement aux artistes 
                                        ayant de fortes perspectives de succès international.
                                    </p>
                                    <p class="col-md-12">Les livres ont été traduits en Anglais, Hongrois, Tchèque, Russe, Lituanien, Allemand, 
                                        Espagnol, Français, Slovaque et Portugais.
                                    </p>
                                    <p class="col-md-12">En 2015, une série télévisée basée sur le cycle du Sorceleur est sortie en Pologne et à 
                                    ...
                                    <p class="col-md-12">En 2015, j'ai décidé de revenir en France afin de consacrer mon temps pour mon roman, Le fou de Lasco. 
                                        Il fut publier en fevrier 2018 et connu un énorme succès.
